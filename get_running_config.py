...
def obtener_running_config(device):
    # Se conecta al router, entra en modo enable y ejecuta show running-config
    try:
...
def guardar_salida(contenido, hostname="CSR1000v"):
    ...
    import os
    nombre_archivo = f"ios_configurations/running_config_{hostname}.txt"
...
if __name__ == "__main__":
    resultado = obtener_running_config(csr1000v)
    ...
    if resultado:
        ...
        print("No se pudo obtener el running-config.")